...
RETURNS trigger AS $builder$
BEGIN
  INSERT INTO public.profiles (id, email, full_name, currency, timezone)
  VALUES (
    new.id,
    new.email,
    COALESCE(new.raw_user_meta_data->>'full_name', 'Isaac Agya Koomson'),
    'GHS',
    'Africa/Accra'
  )
  ...
  RETURN new;
END;
$builder$ LANGUAGE plpgsql SECURITY DEFINER;
